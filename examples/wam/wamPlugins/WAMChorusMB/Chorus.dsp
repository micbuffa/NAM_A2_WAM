...
level	= hslider("level[name:Level] [style:knob]", 0.5, 0, 1, 0.01);
freq	= hslider("freq[name:Freq][style:knob]", 3, 0, 10, 0.01);
dtime	= hslider("delay[name:Delay][style:knob]", 0.02, 0, 0.2, 0.01): si.smooth(0.999);
depth	= hslider("depth[name:Depth][style:knob]", 0.02, 0, 1, 0.01);
...
guitarix = vgroup("chorus", (left, right))
with {
