...
class deathgateNode extends CompositeAudioNode {
  _wamNode;
...
export default class deathgatePlugin extends WebAudioModule {
  _PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new deathgateNode(this.audioContext);
