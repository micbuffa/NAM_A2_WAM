      ...
      class StereoEnhancerNode extends CompositeAudioNode {
          _wamNode;
    ...
    export default class StereoEnhancerPlugin extends WebAudioModule {
  	_PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new StereoEnhancerNode(this.audioContext);
