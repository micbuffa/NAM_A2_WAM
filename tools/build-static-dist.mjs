...
for (const [source, target] of [
  ['examples/wam/index.html', 'index.html'], ['examples/wam/host.css', 'host.css'], ['examples/wam/main.js', 'main.js'],
  ['examples/wam/CabinetRouting.js', 'CabinetRouting.js'], ['examples/wam/OutputDeviceManager.js', 'OutputDeviceManager.js'],
  ['examples/wam/SourceManager.js', 'SourceManager.js'], ['examples/wam/assets', 'assets'],
...
for (const p of ['index.html', 'host.css', 'main.js', 'plugins/nam-wam/index.js', 'plugins/nam-wam/models-manifest.json', 'plugins/nam-wam/nam-simd.wasm', 'plugins/cabinet-wam/index.js', 'plugins/cabinet-wam/irs-manifest.json', 'plugins/cabinet-wam/nam-simd.wasm']) await required(join(dist, p));
