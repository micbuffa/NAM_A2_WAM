  ...
  class NamProcessor extends WamProcessor {
    ...
    _generateWamParameterInfo() {
      return {
        ...
        noiseEnabled: new WamParameterInfo('noiseEnabled', {type:'boolean', label:'Noise Gate Enabled', defaultValue:1}),
        ...
        eqEnabled: new WamParameterInfo('eqEnabled', {type:'boolean', label:'Parametric EQ Enabled', defaultValue:0}),
