...
- FFT storage, the Hann window, bit reversal, and twiddle tables are allocated/precomputed in the AudioWorklet constructor. Analysis runs at about 30 Hz only while the EQ panel is open, and it does not add another `AudioWorkletNode`.
