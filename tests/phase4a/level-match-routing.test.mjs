...
test('TONE3000 canonical gear metadata drives AUTO routing',()=>{assert.deepEqual(detectFullRig({provenance:{gear:'amp-cab'}}),{fullRig:true,reason:'TONE3000 amp-cab metadata'});assert.deepEqual(detectFullRig({provenance:{gear:'amp'}}),{fullRig:false,reason:'TONE3000 amp metadata'});assert.equal(detectFullRig({provenance:{gear:'full-rig'}}).fullRig,true);});
